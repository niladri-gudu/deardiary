      ...
      <CardContent className="grid gap-5">
        <div className="grid gap-4">
          <div className="grid gap-2">
            <Label htmlFor="name" className="text-zinc-400 font-medium ml-1">Full Name</Label>
          ...
          <div className="grid gap-2">
            <Label htmlFor="email-signup" className="text-zinc-400 font-medium ml-1">Email</Label>
            <div className="relative group">
          ...
          <div className="grid gap-2">
            <Label htmlFor="password-signup" className="text-zinc-400 font-medium ml-1">Password</Label>
            <div className="relative group">
        ...
        <p className="text-center text-sm text-zinc-500 mt-2">
          ...
          <Link href="/signin" className="text-zinc-300 hover:text-white underline-offset-4 hover:underline transition-colors">
            Sign in
          </Link>
        </p>
      </CardContent>
