            ...
            {isPending ? (
              ...
              <>
                <Link href="/journal">
                  <Button
                    variant="ghost"
                    className="text-zinc-400 hover:text-zinc-100 hover:bg-zinc-900 transition-all gap-2"
                  >
              ...
              <>
                <Link href="/signin">
                  <Button
                    variant="ghost"
                    className="text-zinc-400 hover:text-zinc-100 hover:bg-zinc-900 transition-all"
                  >
                    Sign In
                  </Button>
                </Link>
